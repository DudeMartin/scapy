 ...
 * user's public chat channel is turned off, chat message events from that
 * channel will be received despite the fact that the user cannot see the
 * messages in the game client.
 *
